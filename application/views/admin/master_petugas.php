                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <?php $no=1; foreach ($data_petugas as $row) : ?>
                    <tr>
                        ...
                        <td><?= $row['level']; ?></td>
                        <td align="center">
                            <a href="<?= base_url('admin/ubah_petugas/' . $row["id_petugas"]); ?>" class="btn btn-sm btn-primary">Ubah</a>
                            <a href="<?= base_url('admin/hapus_petugas/' . $row["id_petugas"]); ?>" class="btn btn-sm btn-danger">Hapus</a>
                        </td>
                    </tr>
                  <?php endforeach; ?>
                  </tbody>
