...
class Auth extends CI_Controller
{
	...
	public function logout()
	{
		...
		$this->session->set_flashdata('message', '<div class="alert alert-success  alert-dismissible fade show" role="alert"> Terimakasih. Silahkan login kembali untuk masuk ke aplikasi.<button type="button" class="close" data-dismiss="alert" aria-label="Close">
			<span aria-hidden="true">&times;</span>
			</button></div>');
		redirect('auth');
	}
